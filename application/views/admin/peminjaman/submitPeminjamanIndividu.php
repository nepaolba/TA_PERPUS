        ...
        <div class="box box-solid">
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <input type="text" disabled class="form-control input-lg" value="<?= date('d/m/Y'); ?>">
                </div>
                <div class="form-group">
                    <label for="">Tanggal Pengembalian</label>
                    <input type="date" id="tanggal" name="tanggal" class="form-control input-lg">
                </div>
            </div>
            <div class="box-footer">
                <button class="btn btn-lg btn-block btn-primary " id="btn-simpan">Simpan</button>
            </div>
        </div>
    </div>
    <div class="col-lg-6">
