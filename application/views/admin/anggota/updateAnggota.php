<div class="row">
   <div class="col-md-12">
      <div class="box box-solid new-shadow">
         ...
         <form role="form" method="post" action="<?= base_url('Anggota/update/' . $data['kd_anggota']) ?>">
            <div class="box-body">
               ...
               <div class="form-group <?= form_error('kd_anggota') ? 'has-error' : '' ?>">
                  ...
                  <input type="text" name="kd_anggota" class="form-control" id="kd_anggota" value="<?= set_value('kd_anggota', $data['kd_anggota']) ?>" placeholder="Masukan NIP/NIS/NIPPPK/USERNAME">
               ...
               <div class="form-group <?= form_error('nama') ? 'has-error' : '' ?>">
                  ...
                  <input type="text" class="form-control" name="nama_anggota" value="<?= set_value('nama_anggota', $data['nama_anggota']) ?>" id="nama" placeholder="Masukan Nama Lengkap Anggota">
               ...
               <div class="form-group <?= form_error('alamat') ? 'has-error' : '' ?>">
                  ...
                  <textarea class="form-control" name="alamat" rows="alamat" id="alamat" placeholder="Masukan alamat ..."><?= set_value('alamat', $data['alamat']) ?></textarea>
               ...
               <div class="form-group <?= form_error('nohp') ? 'has-error' : '' ?>">
                  ...
                  <input type="text" class="form-control" id="nohp" value="<?= set_value('nohp', $data['nohp']) ?>" name="nohp" data-inputmask="'mask': ['089999999999']" data-mask>
