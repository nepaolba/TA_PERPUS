  ...
  <div class="wrapper">
        ...
        <div class="container poppins-semibold">
          ...
          <div class="collapse navbar-collapse " id="navbar-collapse">
            <ul class="nav navbar-nav navbar-right ">
              ...
              <li><a href="<?= base_url('Welcome/koleksi') ?>">Koleksi</a></li>
              <li><a href="<?= base_url('Welcome/daftarPinjam') ?>">Transaksi</a></li>
              <li><a href="<?= base_url('Welcome/kartuAnggota') ?>">Kartu Anggota</a></li>
    ...
    <section class="homePage">
            ...
            <div class="col-lg-7 col-md-6 col-sm-12 col-xs-12 d-flex align-items-center">
              <div class="">
                <h2 class="keterangan poppins-black">
                  ...
                  <span class="text-blue">di <?= $profil->nm_perpus ?></span>
                </h2>
                <p class="poppins-light">
          ...
          <div class="col-lg-12 pt-30 info-img">
            <div class="row">
                          ...
                          foreach ($newbook as $row): ?>
                            <div class="item <?= $i === 0 ? 'active' : '' ?>">
                              <div class="col-lg-5 p-0">
                                <img src="<?= base_url() ?>assets/dist/img/buku/<?= $row->foto ?>" width="100%" alt="<?= $row->judul_buku ?>">
                              </div>
                              <div class="col-lg-7">
                                <div class="carousel-caption">
                                  <p class="text-blue"><?= $row->kategori ?></p>
                                  <h2><?= $row->judul_buku ?></h2>
                                  <p class="text-gray"><?= $row->sinopsis ?></p>
                                  <!-- <a href="<?= base_url('buku/detail/' . $row->kd_buku) ?>" class="btn btn-lg btn-home-outline">BACA SEKARANG</a> -->
                                </div>
                              </div>
                            </div>
                          <?php $i++;
              ...
              <div class="row bener2">
                <div class="col-lg-12">
                  <h3 class="poppins-bold">Sambutan<span class="text-blue">Kepala</span> Sekolah
                    <br>
                    <span class="text-blue">SMAN 5 Kupang</span>
                  </h3>
      ...
      <section class="features">
        <div class="container">
          <div class="row">
            <div class="col-lg-12">
              <h2 class="poppins-bold">Visi & Misi Perpustakaan <span class="text-blue"><?= $profil->nm_perpus ?></span></h2>
            </div>
              ...
              <div class="box box-solid bg-blue" style="box-shadow: 7px 7px 1px #9ecee7;">
                <div class="box-body" style="
                  ...
                  <div class="col-lg-12 pull-right">
                    <h2 class="poppins-extrabold pt-30" style="font-size: 17px; color:#fff; letter-spacing: .5px; line-height: 25px;">Peraturan</h2>
                    <p class="pt-30 pb-30">
                      <?= $profil->aturan ?>
                    </p>
            ...
            <div class="col-lg-6 pt-30">
              <div class="box box-solid" style="background-color:#e0f4fe; box-shadow: 7px 7px 1px #9ecee7;">
                <div class="box-body" style="background-size: contain;
                background-repeat: no-repeat;">
                  <div class="col-lg-12 pull-right">
                    <h2 class="poppins-extrabold pt-30" style="font-size: 17px; color:#424a4c; letter-spacing: .5px; line-height: 25px;">Visi
                    </h2>
                    <p class="pt-30 pb-30">
                      <?= $profil->visi ?>
                    </p>
    ...
    <section class="bener-footer poppins-regular">
      <div class="container">
        <div class="col-lg-3 pt-30">
          ...
          <p style="line-height: 24px;">Perpustakaan SMAN 5 Kupang merupakan bagian dari Sekolah Menengah Atas Negeri 5 Kupang, yang menyediakan berbagai sumber belajar untuk mendukung proses pendidikan dan literasi siswa</p>
        </div>
        ...
        <div class="col-lg-3 pt-30">
          <p>Kontak Kami</p>
          <span><i class="fa fa-whatsapp mr-10"></i><?= $profil->hp ?></span><br>
          <span><i class="fa fa-envelope mr-10"></i><?= $profil->email ?></span><br>
        </div>
        <div class="col-lg-3 pt-30">
          <p>Jam Oprasional</p>
          <div class="layanan">
    ...
    <footer class="main-footer">
      <div class="container">
        ...
        <strong>Copyright &copy; <?= date('Y') ?> <a href="https://adminlte.io">Pedro I.B Mau</a>.</strong> All rights
        reserved.
      </div>
    </footer>
  </div>
